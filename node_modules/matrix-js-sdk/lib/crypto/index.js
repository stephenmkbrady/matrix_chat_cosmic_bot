...
Crypto.prototype.setRoomEncryption = function () {
    var _ref5 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee4(roomId, config, inhibitDeviceQuery) {
        var _this2 = this;
 ...
 */
Crypto.prototype.exportRoomKeys = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee5() {
    var _this3 = this;
...
Crypto.prototype.onCryptoEvent = function () {
    var _ref8 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee6(event) {
        var roomId, content;
    ...
    var _ref11 = (0, _bluebird.method)(function (deviceLists) {
        ...
        if (deviceLists.left && Array.isArray(deviceLists.left)) {
            (function () {
                ...
                // exact correct set.
                var e2eUserIds = new _set2.default(_this6._getE2eUsers());
...
Crypto.prototype._processReceivedRoomKeyRequest = function () {
    var _ref13 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee8(req) {
...
Crypto.prototype._signObject = function () {
    var _ref15 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee9(obj) {
        var sigs;
