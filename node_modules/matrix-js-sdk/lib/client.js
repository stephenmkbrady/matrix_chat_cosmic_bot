...
MatrixClient.prototype.sendStickerMessage = function (roomId, url, info, text, callback) {
    ...
    return this.sendEvent(roomId, "m.room.sticker", content, callback, undefined);
};
            ...
            (function () {
                ...
                callEventBuffer.forEach(function (e) {
                    if (ignoreCallIds[e.getContent().call_id]) {
                        console.log('Ignoring previously answered/hungup call ' + e.getContent().call_id + ' (' + e.getId() + ')');
                        return;
                    }
                    callEventHandler(e);
                });
